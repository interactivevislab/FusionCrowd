...
/*!
 *	@file		JohanssonInitializer.h
 *	@brief		The AgentInitializer for the Johansson simulator.
 */
#ifndef __JOHANSSON_INITIALIZER_H__
#define	__JOHANSSON_INITIALIZER_H__

#include "Agents/AgentInitializer.h"

namespace Johansson {
	/*!
	 *	@brief		Class which determines the agent properties for each new Johansson agent.
	 */
	...
	protected:
		 ...
		 *	mechanism by which derived classes will also benefit from the `<Johansson>`
		 *	parameter set.
		 *
		 ...
		 */
		Menge::Math::FloatGenerator *	_dirWeight;
	};
}	// namespace Johansson

#endif	// __JOHANSSON_INITIALIZER_H__

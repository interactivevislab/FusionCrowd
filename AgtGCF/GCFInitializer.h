...
/*!
 *	@file		GCFInitializer.h
 *	@brief		The AgentInitializer for the generalized centrifugal force simulator.
 */
...
namespace GCF {
	...
	//protected:
		 ...
		 *	mechanism by which derived classes will also benefit from the `<GCF>`
		 *	parameter set.
		 *

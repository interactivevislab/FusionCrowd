...
NavMesh = namedtuple("NavMesh", ["vertices", "edges", "nodes", "xmin", "ymin", "xmax", "ymax"])
...
def read_mesh(filename):
    ...
    return NavMesh(vertices=vertices, edges=edges, nodes=nodes, xmin=xmin, ymin=ymin, xmax=xmax, ymax=ymax)

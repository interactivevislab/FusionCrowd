...
namespace Menge {
  ...
  public:
     ...
     *
     *  @param    scene_name  The path to the scene specificaiton XML file. If relative, it is
     ...
     *  @param  scb_version   The version string; if the version string is invalid, this will be
     ...
     *
     *  @param    view_name   The path to the view specification file. If the path is relative, it
     *                        is relative to the project file.
     */
     ...
     *
     *  @param    sub_step_count    The number of steps to take between each major time step 
     *                              defined by getTimeStep().
     */

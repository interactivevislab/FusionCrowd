...
/*!
 *	@file		ORCAInitializer.h
 *	@brief		The AgentInitializer for the ORCA simulator.
 */
...
namespace ORCA {
	/*!
	 *	@brief		Class which determines the agent properties for each new ORCA agent.
	 */
	...
	//protected:
		 ...
		 *	mechanism by which derived classes will also benefit from the `<ORCA>`
		 *	parameter set defined in the base class (or any other derived dependency).
		 *
...
#endif	// __OPENSTEER_INITIALIZER_H__
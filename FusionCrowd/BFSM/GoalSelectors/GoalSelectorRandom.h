...
#include "../../BFSM/GoalSelectors/GoalSelectorSet.h"

namespace Menge {

	namespace BFSM {
		/*!
		 *	@brief		The random goal selector selects a goal from a goal set with
		 *				uniform probability (i.e., it ignores the goal weights).
		 */

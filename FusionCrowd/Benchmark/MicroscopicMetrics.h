...
namespace FusionCrowd
{
	namespace MicroscopicMetrics
	{
		...
		static float PathLength(IRecording & rec1, IRecording & rec2);
		static float InnerPedestrianDistance(IRecording & rec1, IRecording & rec2);
		static float ProgressiveDistance(IRecording & rec1, IRecording & rec2);
	};
}

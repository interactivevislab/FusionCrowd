...
#include "../../Agents/Events/EventTrigger.h"
#include "../../Agents/Events/EventTriggerFactory.h"
...
namespace Menge {
	...
	public:
		...
		/*!
		 *	@brief		Activates the trigger so that its condition is met at the beginning
		 *				of the next simulation timestep.
		 */

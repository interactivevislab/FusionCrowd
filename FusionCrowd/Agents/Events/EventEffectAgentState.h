...
#include "../../Agents/Events/AgentEventEffect.h"
...
namespace Menge {
	...
	protected:
		 ...
		 *	@throws		EventFatalException if the selector generates a state name that cannot
		 *				be found in the BFSM.
		 */
	...
	protected:
		...
		EventEffect * instance() const override {
			return new EventEffectAgentState();
		}

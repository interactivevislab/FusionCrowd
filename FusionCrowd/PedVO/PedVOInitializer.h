...
/*!
 *	@file		PedVOInitializer.h
 *	@brief		The AgentInitializer for the PedVO simulator.
 */
...
namespace PedVO {
	/*!
	 *	@brief		Class which determines the agent properties for each new PedVO agent.
	 */
	...
	protected:
		 ...
		 *	mechanism by which derived classes will also benefit from the `<PedVO>`
		 *	parameter set.
		 *

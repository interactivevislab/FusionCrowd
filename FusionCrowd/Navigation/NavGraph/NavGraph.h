...
namespace FusionCrowd
{
	...
	public:
		...
		const NavGraphNodeId GetClosestNodeIdByPosition(DirectX::SimpleMath::Vector2 p, std::unordered_map<NavGraphNodeId, NavGraphNode> const nodes);
		...
		std::unordered_map<NavGraphNodeId, NavGraphNode> GetAllNodes() const;
	private:

...
namespace FusionCrowd
{
	namespace Zanlungo
	{
		...
		public:
			...
			FusionCrowd::Math::Vector2 AgentForce(FusionCrowd::Agent* agent, const FusionCrowd::Agent* other, float T_i) const;

			float RightOfWayVel(FusionCrowd::Agent* agent, FusionCrowd::Math::Vector2& otherVel, const FusionCrowd::Math::Vector2& otherPrefVel,

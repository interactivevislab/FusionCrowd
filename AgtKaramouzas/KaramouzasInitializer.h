...
/*!
 *	@file		KaramouzasInitializer.h
 *	@brief		The AgentInitializer for the Karamouzas simulator.
 */
#ifndef __KARAMOUZAS_INITIALIZER_H__
#define	__KARAMOUZAS_INITIALIZER_H__
...
namespace Karamouzas {
	...
	protected:
		 ...
		 *	mechanism by which derived classes will also benefit from the `<Karamouzas>`
		 *	parameter set.
		 *
...
#endif	// __KARAMOUZAS_INITIALIZER_H__
